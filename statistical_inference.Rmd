...
plot<-ggplot(data = subset(ToothGrowth,supp=="OJ"), aes(x = len,  colour="red", fill = "red", alpha=0.1)) + theme(legend.position="none") + geom_density() +  geom_vline(xintercept = median(ToothGrowth$len), size = .75, color = "blue")
plot
...
plot<-ggplot(data = subset(ToothGrowth,dose==0.5), aes(x = len,  colour="red", fill = "red", alpha=0.1)) + theme(legend.position="none") + geom_density() +  geom_vline(xintercept = median(ToothGrowth$len), size = .75, color = "blue")
plot

#plot the dose=1.0 distribution
plot<-ggplot(data = subset(ToothGrowth,dose==1.0), aes(x = len,  colour="red", fill = "red", alpha=0.1)) + theme(legend.position="none") + geom_density() +  geom_vline(xintercept = median(ToothGrowth$len), size = .75, color = "blue")
plot

#plot the dose=2.0 distribution
plot<-ggplot(data = subset(ToothGrowth,dose==2.0), aes(x = len,  colour="red", fill = "red", alpha=0.1)) + theme(legend.position="none") + geom_density() +  geom_vline(xintercept = median(ToothGrowth$len), size = .75, color = "blue")
plot
