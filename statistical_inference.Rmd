...
str(ed)
n<-ggplot(data = ed, aes(x = val)) + geom_histogram(aes(y=..density..), colour="black", fill = "white") + geom_density(alpha=0.2, fill="#FF6666") + theme(legend.position="none") +  geom_density() +  geom_vline(xintercept = mean(ed$val), linetype="dashed", size = .75, color = "blue") 
n
```
...
n<-ggplot(data = sam, aes(x = val)) + geom_histogram(aes(y=..density..), colour="black", fill = "white") + geom_density(alpha=0.2, fill="#FF6666") + theme(legend.position="none") +  geom_density() +  geom_vline(xintercept = mean(sam$val), linetype="dashed", size = .75, color = "blue") + 
